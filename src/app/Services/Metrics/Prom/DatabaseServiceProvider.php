...
namespace App\Services\Metrics\Prom;;

use App\Models\SqlRefs;
...
class DatabaseServiceProvider extends ServiceProvider
{
    ...
    private $sqlRef = 'f093095257c0fbe2bba7cde1b57176e6';
    ...
    public function boot(): void
    {
        DB::listen(function ($query) {
            ...
            try {
                SqlRefs::firstOrCreate(['key' => $key, 'value' => $querySql]);
            } catch (\Exception $e) {
                Log::error('Prometheus SQL queries error', ['message' => $e->getMessage()]);
            }
